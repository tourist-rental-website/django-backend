...
from .views import (GuideProfileUpdateView, GuideProfileListView, HotelProfileUpadateView, HotelProfileListView, 
                    PackageListView, RoomCreateView, RoomListView, PackageCreateView, RoomImageUploadView)
urlpatterns = [
    ...
    path("rooms/<int:room_id>/images/", RoomImageUploadView.as_view(), name="room-image-upload"),
