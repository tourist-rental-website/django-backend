...
class Room(models.Model):
    hotel = models.ForeignKey(HotelProfile, on_delete=models.CASCADE, related_name="rooms")
    ROOM_TYPE_CHOICES = (
        ("deluxe", "Deluxe"),
        ("standard", "Standard"),
        ("suite", "Suite"),
...
class Package(models.Model):
    guide = models.ForeignKey(GuideProfile, on_delete=models.CASCADE, related_name="packages")
